...
# /segments/assign "eligible" vs "skipped"
A contact converges into a scheduled_email ONLY when its `sequence_status` is NOT in
the stopped set [paused_replied,paused_manual,do_not_contact,unsubscribed,bounce]
AND NOT in the active set [active,pending,enrolled,in_progress,scheduled].
