...
export const bulkSendCampaignsTable = pgTable("bulk_send_campaigns", {
  ...
  sendsPerHour: integer("sends_per_hour").default(50),
  delayBetweenSendsMs: integer("delay_between_sends_ms").default(5000),
  ...
  totalRetried: integer("total_retried").default(0),
  status: text("status").default("pending"),
  queueStartedAt: timestamp("queue_started_at"),
  queueCompletedAt: timestamp("queue_completed_at"),
