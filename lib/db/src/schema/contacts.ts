...
export const contactsTable = pgTable("contacts", {
  ...
  customLineStatus: text("custom_line_status").default("not_generated"),
  customLineSource: text("custom_line_source"),
  customLineGeneratedAt: timestamp("custom_line_generated_at"),
  customLineLocked: boolean("custom_line_locked").default(false),
  ...
  routingState: text("routing_state").default("standard_nurture"),
  routingLocked: boolean("routing_locked").default(false),
  recommendedNextAction: text("recommended_next_action"),
  qualifiedStatus: text("qualified_status").default("unreviewed"),
