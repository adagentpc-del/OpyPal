...
const WORKSPACE_SEEDS: WorkspaceSeed[] = [
  ...
  },
  {
    ...
    templateCategories: [
      { name: "Realtors", description: "Outreach to realtors and real estate agents" },
      ...
      { name: "Condo Associations", description: "Outreach to condo associations and HOAs" },
      { name: "Luxury Residential", description: "Outreach for high-end, white-glove residential moves" },
  ...
  },
  {
    ...
    templateCategories: [
      { name: "Functional Medicine Clinics", description: "Outreach to functional medicine practices" },
      { name: "Longevity Clinics", description: "Outreach to longevity and healthspan clinics" },
      { name: "Wellness Clinics", description: "Outreach to wellness and integrative clinics" },
      { name: "Med Spas", description: "Outreach to med spas and aesthetic providers" },
      { name: "Provider Groups", description: "Outreach to multi-provider groups and networks" },
