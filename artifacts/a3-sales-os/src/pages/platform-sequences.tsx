...
import { ListOrdered, Loader2, ArrowRight, Info } from "lucide-react";

// Global Sequences mirrors Global Templates: sequences are workspace-owned, so
// this page lists workspaces and routes the super admin into each one's
// sequence manager. Aggregate authoring lands in a later pass.
    ...
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Global Sequences</h1>
            <p className="text-sm text-muted-foreground">
              Multi-step sequences across every workspace.
            </p>
          </div>
        </div>
        ...
        <Card className="flex items-start gap-3 border-primary/20 bg-primary/5 p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Sequences are managed within each workspace. Choose a workspace below
            to view and edit its sequences. Shared platform-wide sequence
